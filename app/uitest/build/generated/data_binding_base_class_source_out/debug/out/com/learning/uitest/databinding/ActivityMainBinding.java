...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull FragmentContainerView mainFragmentContainerView, @NonNull TabLayout mainTabLayout) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.main_tabLayout;
      TabLayout mainTabLayout = ViewBindings.findChildViewById(rootView, id);
      if (mainTabLayout == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, mainFragmentContainerView,
          mainTabLayout);
    }
